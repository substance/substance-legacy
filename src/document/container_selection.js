...
ContainerSelection.Prototype = function() {
  ...
  this.toString = function() {
    return "("+ this.container + ": " + JSON.stringify(this.range.start.path) + ":" + this.range.start.offset + ") -> (" +  JSON.stringify(this.range.end.path) + ":" + this.range.end.offset + (this.reverse ? "; reverse" : "") + ")";
  };

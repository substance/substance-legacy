...
function activateCodeMirror(a){var b=function(d){return d.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")};a=$(a);if(!a.data("codemirror")){var c=CodeMirror.fromTextArea(a.get(0),{mode:"javascript",lineNumbers:true,theme:"elegant",indentUnit:2,indentWithTabs:false,tabMode:"shift",readOnly:app.document.mode!=="edit",onFocus:function(){a.trigger("click")},onChange:_.throttle(function(){app.document.updateSelectedNode({content:b(c.getValue())})},500)});setTimeout(function(){c.refresh()},
10);a.data("codemirror",c)}return a.data("codemirror")}_.slug=function(a){a=a.replace(/^\s+|\s+$/g,"");a=a.toLowerCase();for(var b=0;b<28;b++)a=a.replace(RegExp("\u00e0\u00e1\u00e4\u00e2\u00e8\u00e9\u00eb\u00ea\u00ec\u00ed\u00ef\u00ee\u00f2\u00f3\u00f6\u00f4\u00f9\u00fa\u00fc\u00fb\u00f1\u00e7\u00b7/_,:;".charAt(b),"g"),"aaaaeeeeiiiioooouuuunc------".charAt(b));return a=a.replace(/[^a-z0-9 -]/g,"").replace(/\s+/g,"-").replace(/-+/g,"-")};_.scrollTop=function(){return document.body.scrollTop||document.documentElement.scrollTop};

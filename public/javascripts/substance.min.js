...
_.gravatar=function(a,b){b=b||80;return"http://www.gravatar.com/avatar/"+function(c){function d(o,n){var q,p,u,t,s;u=o&2147483648;t=n&2147483648;q=o&1073741824;p=n&1073741824;s=(o&1073741823)+(n&1073741823);if(q&p)return s^2147483648^u^t;return q|p?s&1073741824?s^3221225472^u^t:s^1073741824^u^t:s^u^t}function e(o,n,q,p,u,t,s){o=d(o,d(d(n&q|~n&p,u),s));return d(o<<t|o>>>32-t,n)}function j(o,n,q,p,u,t,s){o=d(o,d(d(n&p|q&~p,u),s));return d(o<<t|o>>>32-t,n)}function l(o,n,q,p,u,t,s){o=d(o,d(d(n^q^p,u),
s));return d(o<<t|o>>>32-t,n)}function m(o,n,q,p,u,t,s){o=d(o,d(d(q^(n|~p),u),s));return d(o<<t|o>>>32-t,n)}function r(o){var n="",q="",p;for(p=0;p<=3;p++){q=o>>>p*8&255;q="0"+q.toString(16);n+=q.substr(q.length-2,2)}return n}var k=[],w,v,x,y,h,g,f,i;c=function(o){o=o.replace(/\r\n/g,"\n");for(var n="",q=0;q<o.length;q++){var p=o.charCodeAt(q);if(p<128)n+=String.fromCharCode(p);else{if(p>127&&p<2048)n+=String.fromCharCode(p>>6|192);else{n+=String.fromCharCode(p>>12|224);n+=String.fromCharCode(p>>
6&63|128)}n+=String.fromCharCode(p&63|128)}}return n}(c);k=function(o){var n,q=o.length;n=q+8;for(var p=((n-n%64)/64+1)*16,u=Array(p-1),t=0,s=0;s<q;){n=(s-s%4)/4;t=s%4*8;u[n]|=o.charCodeAt(s)<<t;s++}n=(s-s%4)/4;t=s%4*8;u[n]|=128<<t;u[p-2]=q<<3;u[p-1]=q>>>29;return u}(c);h=1732584193;g=4023233417;f=2562383102;i=271733878;for(c=0;c<k.length;c+=16){w=h;v=g;x=f;y=i;h=e(h,g,f,i,k[c+0],7,3614090360);i=e(i,h,g,f,k[c+1],12,3905402710);f=e(f,i,h,g,k[c+2],17,606105819);g=e(g,f,i,h,k[c+3],22,3250441966);h=e(h,
g,f,i,k[c+4],7,4118548399);i=e(i,h,g,f,k[c+5],12,1200080426);f=e(f,i,h,g,k[c+6],17,2821735955);g=e(g,f,i,h,k[c+7],22,4249261313);h=e(h,g,f,i,k[c+8],7,1770035416);i=e(i,h,g,f,k[c+9],12,2336552879);f=e(f,i,h,g,k[c+10],17,4294925233);g=e(g,f,i,h,k[c+11],22,2304563134);h=e(h,g,f,i,k[c+12],7,1804603682);i=e(i,h,g,f,k[c+13],12,4254626195);f=e(f,i,h,g,k[c+14],17,2792965006);g=e(g,f,i,h,k[c+15],22,1236535329);h=j(h,g,f,i,k[c+1],5,4129170786);i=j(i,h,g,f,k[c+6],9,3225465664);f=j(f,i,h,g,k[c+11],14,643717713);
...
var renderControls=function(a,b,c,d,e){function j(l,m,r){function k(v,x){function y(f){if(!(f.nodeType==="/type/section"&&f.level>3))if(w.get(f.nodeType))if(f.nodeType==="/type/section")w.get(f.nodeType).push(f);else f.level>w.get(f.nodeType)[0].level&&w.set(f.nodeType,[f]);else w.set(f.nodeType,[f])}var h=parseInt($("#"+v.html_id).attr("level"));if(v.all("children")&&v.all("children").length===0&&m==="after"){var g=v.properties().get("children").expectedTypes;_.each(g,function(f){y({node:v._id,parentNode:x?
x._id:null,nodeType:f,nodeTypeName:graph.get(f).name,insertionType:"child",level:h+1})})}if(x){g=x.properties().get("children").expectedTypes;_.each(g,function(f){y({node:v._id,parentNode:x?x._id:null,nodeType:f,nodeTypeName:graph.get(f).name,insertionType:"sibling",level:h})})}r&&v.all("children")&&v.all("children").length>0&&k(v.all("children").last(),v);return w}var w=new Data.Hash;return _.tpl("controls",{node:l.key,destination:m,actions:k(l,d)})}if(d){b&&$(j(a,"before")).insertBefore($("#"+a.html_id));
if(d.types().get("/type/document"))$(j(a,"after",true)).insertAfter($("#"+a.html_id));else c||$(j(a,"after")).insertAfter($("#"+a.html_id))}else{$("#document .controls").remove();if(!a.all("children")||a.all("children").length===0)$(j(a,"after")).appendTo($("#"+a.html_id))}a.all("children")&&a.all("children").each(function(l,m,r){m=r===0;r=r===a.all("children").length-1;renderControls(l,m,r,a,e+1)})},HTMLRenderer=function(a,b,c){var d={"/type/document":function(e,j,l){var m="";(j=e.all("children"))&&
j.each(function(r){m+=d[r.type._id](r,e,l+1)});return _.tpl("document",{node:e,content:m,edit:app.document.mode==="edit",title:e.get("title"),lead:e.get("lead"),empty_lead:app.document.mode==="edit"&&(!e.get("lead")||e.get("lead")===""),empty_title:app.document.mode==="edit"&&(!e.get("title")||e.get("title")===""),level:l})},"/type/story":function(e,j,l){return d["/type/document"](e,j,l)},"/type/conversation":function(e,j,l){return d["/type/document"](e,j,l)},"/type/article":function(e,j,l){return d["/type/document"](e,
j,l)},"/type/manual":function(e,j,l){return d["/type/document"](e,j,l)},"/type/qaa":function(e,j,l){return d["/type/document"](e,j,l)},"/type/section":function(e,j,l){var m="";e.all("children")&&e.all("children").each(function(r){m+=d[r.type._id](r,e,l+1)});return Helpers.renderTemplate("section",{node:e,parent:j,content:m,heading_level:l+1,level:l,edit:app.document.mode==="edit",name:e.get("name"),empty:app.document.mode==="edit"&&(!e.get("name")||e.get("name")==="")})},"/type/text":function(e,j,
l){return Helpers.renderTemplate("text",{node:e,parent:j,edit:app.document.mode==="edit",content:e.get("content"),empty:app.document.mode==="edit"&&(!e.get("content")||e.get("content")==="<p></p>"),level:l})},"/type/quote":function(e,j,l){return Helpers.renderTemplate("quote",{node:e,parent:j,edit:app.document.mode==="edit",content:e.get("content"),author:e.get("author"),empty_content:app.document.mode==="edit"&&(!e.get("content")||e.get("content")===""),empty_author:app.document.mode==="edit"&&(!e.get("author")||
e.get("author")===""),level:l})},"/type/code":function(e,j,l){return Helpers.renderTemplate("code",{node:e,parent:j,edit:app.document.mode==="edit",content:e.get("content"),empty:app.document.mode==="edit"&&(!e.get("content")||e.get("content")===""),level:l})},"/type/question":function(e,j,l){return Helpers.renderTemplate("question",{node:e,parent:j,edit:app.document.mode==="edit",content:e.get("content"),empty:app.document.mode==="edit"&&(!e.get("content")||e.get("content")===""),level:l})},"/type/answer":function(e,
j,l){return Helpers.renderTemplate("answer",{node:e,parent:j,edit:app.document.mode==="edit",content:e.get("content"),empty:app.document.mode==="edit"&&(!e.get("content")||e.get("content")===""),level:l})},"/type/image":function(e,j,l){return Helpers.renderTemplate("image",{node:e,parent:j,edit:app.document.mode==="edit",url:e.get("url"),level:l,empty:app.document.mode==="edit"&&(!e.get("caption")||e.get("caption")===""),caption:e.get("caption"),transloadit_params:config.transloadit})},"/type/visualization":function(e,
j,l){return Helpers.renderTemplate("visualization",{node:e,parent:j,edit:app.document.mode==="edit",visualization_type:e.get("visualization_type"),data_source:e.get("data_source"),level:l})}};return{render:function(){return d[a.type._id](a,b,parseInt(c))}}},TOCRenderer=function(a){var b={"/type/document":function(c){content="<h2>Table of contents</h2>";content+="<ul>";c.all("children").each(function(d){content+='<li><a class="toc-item" node="'+d.html_id+'" href="#'+a.get("creator")._id.split("/")[2]+
"/"+a.get("name")+"/"+d.html_id+'">'+d.get("name")+"</a></li>"});content+="</ul>";return content},"/type/story":function(c){return b["/type/document"](c)},"/type/conversation":function(){return""},"/type/manual":function(c,d){return b["/type/document"](c,d)},"/type/article":function(c,d){return b["/type/document"](c,d)},"/type/qaa":function(c,d){return b["/type/document"](c,d)}};return{render:function(){return b[a.type._id](a)}}},DocumentEditor=Backbone.View.extend({events:{"keydown .property":"updateNode"},
initialize:function(){function a(){editor.activate(c.$node,{multiline:false,markup:false,placeholder:"Enter Title"});editor.bind("changed",function(){c.updateNode({title:editor.content()})})}function b(){editor.activate(c.$lead,{multiline:false,markup:false,placeholder:"Enter lead"});editor.bind("changed",function(){c.updateNode({lead:editor.content()})})}var c=this;this.$node=$("#"+app.document.selectedNode.html_id+" > h1.content").unbind();this.$lead=$("#"+app.document.selectedNode.html_id+" #document_lead").unbind();
c.$node.bind("click",a);c.$lead.bind("click",b);document.activeElement===c.$node[0]?a():b();return true},updateNode:function(a){app.document.updateSelectedNode(a);app.document.trigger("changed")}}),SectionEditor=Backbone.View.extend({events:{"keydown .property":"updateNode"},initialize:function(){this.render();this.$node=$("#"+app.document.selectedNode.html_id+" > .content").attr("contenteditable",true).unbind();editor.activate(this.$node,{placeholder:"Enter Section Name",multiline:false,markup:false});
editor.bind("changed",function(){app.document.updateSelectedNode({name:editor.content()})})},render:function(){}}),TextEditor=Backbone.View.extend({events:{},initialize:function(){this.render();this.$content=this.$("div.content");editor.activate(this.$content,{placeholder:"Enter Text",controlsTarget:$("#document_actions")});editor.bind("changed",function(){app.document.updateSelectedNode({content:editor.content()})})},render:function(){}}),QuoteEditor=Backbone.View.extend({events:{},initialize:function(){function a(){editor.activate(c.$content,
...
updateNode:function(){setTimeout(function(){app.document.updateSelectedNode({content:editor.content()})},5)},render:function(){}}),ImageEditor=Backbone.View.extend({events:{"change .image-file ":"upload"},upload:function(){console.log(this.$(".upload-image-form"));this.$(".upload-image-form").submit()},initialize:function(){var a=this;this.$caption=this.$(".caption");editor.activate(this.$caption,{placeholder:"Enter Caption",multiline:false,markup:false});editor.bind("changed",function(){app.document.updateSelectedNode({caption:editor.content()})});
this.$(".upload-image-form").transloadit({modal:false,wait:true,autoSubmit:false,onProgress:function(b,c){var d=parseInt(b/c*100);a.$(".image-progress").show();d>=0||(d=0);console.log("upload complete: "+d);a.$(".progress-bar").attr("style","width:"+d+"%")},onError:function(b){console.log(b.error+": "+b.message);alert(b.error+": "+b.message);a.$(".progress-container").hide()},onSuccess:function(b){if(b.results.resize_image&&b.results.resize_image[0]&&b.results.resize_image[0].url){app.document.updateSelectedNode({url:b.results.resize_image[0].url,
dirty:true});app.document.reset();a.$(".progress-container").hide()}}})},render:function(){}}),ApplicationController=Backbone.Controller.extend({routes:{"^(?!search)(.*)/(.*)$":"loadDocument","^(?!search)(.*)/(.*)/(.*)$":"loadDocument",":username":"userDocs","^search/(.*)$":"searchDocs"},loadDocument:function(a,b,c){app.browser.load({type:"user",value:a});app.document.loadDocument(a,b,c);$("#document_wrapper").attr("url","#"+a+"/"+b);$("#browser_wrapper").attr("url","#"+a);return false},userDocs:function(a){if(!a)if(app.username)a=
app.username;else return app.toggleStartpage();a==="recent"?app.browser.load({type:"recent",value:50}):app.browser.load({type:"user",value:a});$("#browser_wrapper").attr("url","#"+a);app.browser.bind("loaded",function(){app.toggleView("browser");app.browser.unbind("loaded")});return false},searchDocs:function(a){app.searchDocs(a);return false}}),UI={};
...
return false},loadDocument:function(a,b,c,d){function e(l){j.model=graph.get(l);if(j.model){j.render();j.init();j.reset();j.trigger("changed");j.loadedDocuments[a+"/"+b]=l;app.browser.graph.set("objects",l,j.model);app.toggleView("document")}else $("#document_wrapper").html("Document loading failed")}var j=this;j.mode=d||(a===this.app.username?"edit":"show");if(j.mode==="edit"&&!head.browser.webkit){alert("You need to use a Webkit-based browser (Google Chrome, Safari) in order to write documents. In future, other browers will be supported too.");
j.mode="show"}$("#tabs").show();c=j.loadedDocuments[a+"/"+b];$("#document_tab").show();if(c)e(c);else{$("#document_tab").html("&nbsp;&nbsp;&nbsp;Loading...");$.ajax({type:"GET",url:"/documents/"+a+"/"+b,dataType:"json",success:function(l){if(l.status==="error")$("#document_wrapper").html("Document loading failed");else{graph.merge(l.graph);e(l.id)}},error:function(){$("#document_wrapper").html("Document loading failed")}})}},closeDocument:function(){this.model=null;controller.saveLocation("#"+this.app.username);
...
e=$(a.currentTarget).attr("destination"),j=graph.set(null,{type:b,document:this.model._id});else{c=graph.get(arguments[1]);d=graph.get(arguments[2]);e=arguments[3];j=graph.set(arguments[0].nodeId,arguments[0])}var l=d.all("children").index(c._id);if(e==="after")l+=1;if(b==="/type/section"){b=d.get("children").rest(l);c=d.get("children").select(function(m,r,k){return k<l});d.set({children:c.keys()});j.set({children:b.keys()})}d.all("children").set(j._id,j,l);d.dirty=true;this.trigger("change:node",
d);this.selectedNode=j;this.trigger("select:node",this.selectedNode);return false},removeNode:function(a){if(arguments.length===1)var b=graph.get($(a.currentTarget).attr("node")),c=graph.get($(a.currentTarget).attr("parent"));else{b=graph.get(arguments[0]);c=graph.get(arguments[1])}c.all("children").del(b._id);graph.del(b._id);c.dirty=true;this.trigger("change:node",c);return false}}),Attributes=Backbone.View.extend({initialize:function(){},render:function(){app.document.mode==="edit"?this.renderEdit():
...
$(this.el).html(_.tpl("edit_attributes",{attributes:c,doc:b}));$(".attribute-editor").each(function(){var d=$(this).attr("property");graph.get("/type/"+d.split("/")[1]).get("properties",d.split("/")[2]);var e=$(this).attr("key"),j=$(this).hasClass("unique"),l=$(this).attr("type");value=j?app.document.model.get(e).get("name"):_.map(app.document.model.get(e).values(),function(r){return r.get("name")});var m=a.createAttributeEditor(e,l,j,value,$(this));m.bind("input:changed",function(r){if(r.length<
2)return m.updateSuggestions({});$.ajax({type:"GET",data:{member:d,search_str:r},url:"/attributes",dataType:"json"}).success(function(k){graph.merge(k.graph);m.updateSuggestions(k.graph)})});m.bind("changed",function(){var r=[];_.each(m.value(),function(w){var v=graph.find({"type|=":["/type/attribute"],member_of:d,name:w}).first();v||(v=graph.set(null,{type:["/type/attribute"],member_of:d,name:w}));r.push(v._id)});var k={};k[e]=r;app.document.model.set(k);app.document.trigger("changed")})})},createAttributeEditor:function(a,
...
e){if(d.meta.facet){var j=[],l=[];d.all("values").each(function(m){a.facetChoices[e+"::CONTAINS::"+m._id]===true?l.push({key:escape(m._id),value:m.toString(),item_count:m.referencedObjects.length}):j.push({key:escape(m._id),value:m.toString(),item_count:m.referencedObjects.length})});j.length+l.length>0&&b.facets.push({property:e,property_name:d.name,facet_choices:j,selected_facet_choices:l})}});return b},render:function(){$(this.el).html(_.renderTemplate("facets",this.buildView()))}}),Collaborators=
...
url:"/documents/"+app.username+"/"+b,dataType:"json",success:function(d){if(d.status==="error")a.document.newDocument(c,b);else{$("#create_document input[name=new_document_name]").addClass("error");$("#new_document_name_message").html("This document name is already taken.")}},error:function(){$("#document_wrapper").html("Document loading failed")}});return false}else{$("#create_document input[name=new_document_name]").addClass("error");$("#new_document_name_message").html("Invalid document name. No spaces or special characters allowed.")}return false},

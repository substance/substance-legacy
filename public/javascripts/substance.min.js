...
e=d(e,v);f=d(f,w);g=d(g,y);h=d(h,x)}return(u(e)+u(f)+u(g)+u(h)).toLowerCase()}(a)+".jpg?s="+b};
...
a.all("children").each(function(k,l,m){l=m===0;m=m===a.all("children").length-1;renderControls(k,l,m,a)})},HTMLRenderer=function(a,b){var c={"/type/document":function(d){var j="",k=d.all("children");k&&k.each(function(l){j+=c[l.type._id](l,d)});return _.tpl("document",{node:d,content:j,edit:app.document.mode==="edit",title:d.get("title"),lead:d.get("lead")})},"/type/story":function(d,j){return c["/type/document"](d,j)},"/type/conversation":function(d,j){return c["/type/document"](d,j)},"/type/article":function(d,
j){return c["/type/document"](d,j)},"/type/manual":function(d,j){return c["/type/document"](d,j)},"/type/qaa":function(d,j){return c["/type/document"](d,j)},"/type/section":function(d,j){var k="";d.all("children")&&d.all("children").each(function(l){k+=c[l.type._id](l,d)});return Helpers.renderTemplate("section",{node:d,parent:j,content:k,edit:app.document.mode==="edit",name:d.get("name")})},"/type/text":function(d,j){return Helpers.renderTemplate("text",{node:d,parent:j,edit:app.document.mode===
"edit",content:d.get("content")})},"/type/quote":function(d,j){return Helpers.renderTemplate("quote",{node:d,parent:j,edit:app.document.mode==="edit",content:d.get("content"),author:d.get("author")})},"/type/code":function(d,j){return Helpers.renderTemplate("code",{node:d,parent:j,edit:app.document.mode==="edit",content:d.get("content")})},"/type/question":function(d,j){return Helpers.renderTemplate("question",{node:d,parent:j,edit:app.document.mode==="edit",content:d.get("content")})},"/type/answer":function(d,
j){return Helpers.renderTemplate("answer",{node:d,parent:j,edit:app.document.mode==="edit",content:d.get("content")})},"/type/image":function(d,j){return Helpers.renderTemplate("image",{node:d,parent:j,edit:app.document.mode==="edit",url:d.get("url")})},"/type/visualization":function(d,j){return Helpers.renderTemplate("visualization",{node:d,parent:j,edit:app.document.mode==="edit",visualization_type:d.get("visualization_type"),data_source:d.get("data_source")})}};return{render:function(){return c[a.type._id](a,

...
var AnnotatedDocument = _.inherits(Document, {
  constructor: function(options) {
    ...
    // Override apply annotations
    this.annotations.apply = function(op, silent) {
      Document.prototype.apply.call(this, op, silent);

      // Remember ref for reconstructiaun
      if (!silent) {
        console.log('remembering ref shizzle');
        this.model.refs[that.model.refs["master"]] = this.model.refs["master"];
      }
    };
  },
  ...
  checkout: function(ref) {
    ...
    Document.prototype.checkout.call(this.annotations, ref);
  },

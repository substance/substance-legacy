  ...
  Data.Object = _.inherits(Data.Node, {
    ...
    setObjectProperty: function(p, values)  {
      ...
      _.each(values, function(v, index) {
        ...
        // Listen on the property hash for changes (makes the object dirty)
        // that.all(p.key).bind('set', function(valueKey) {
        //   // TODO: make sure this is not too often implicitly because I guess that's the case
        //   that.dirty = true;
        // });
